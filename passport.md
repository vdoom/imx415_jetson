...
| Розміри кадру reference-драйвера | **3864×2192**, єдиний режим; **15 fps** @ 2-lane (не 30 — див. нижче). **Наш порт з 2026-07-08: 4 лейни, 30 fps**, два режими (GB10/GB12), HMAX 1100 | ✅ |
...
| pix_clk_hz | Фаза A (2-lane): 178 200 000, 15 fps (перерахунок у `rpi5_imx415_data.md` §2.3). **Чинний DT (4-lane, 30 fps): 356 400 000** (mode0 GB10, `line_length` 5280) / **297 000 000** (mode1 GB12, `line_length` 4400) | ✅ |
...
1. **15 fps @ 2-lane, не 30.** 3864·2192·10·30 = 2.54 Гбіт/с > 1.782 Гбіт/с (2×891M).
   ...
   **зроблено 2026-07-08**: CAM1 має всі 4 лейни, порт переведено (LANEMODE=3,
   HMAX 1100, exp 59–33200 мкс); 2-lane стан збережено як тег
   `phase1-2lane-15fps` + `deploy/2lane-15fps-backup/`.
