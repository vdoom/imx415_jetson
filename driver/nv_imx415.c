 ...
 *
 * Builds against L4T r36 (Linux 5.15, JetPack 6) and L4T r39 (Linux 6.8,
 * JetPack 7); the kernel-API differences are taken from <nvidia/conftest.h>
 * (generated by NVIDIA's build, or by ./conftest.sh for the standalone
 * JetPack 7 build - see Makefile).
 */
